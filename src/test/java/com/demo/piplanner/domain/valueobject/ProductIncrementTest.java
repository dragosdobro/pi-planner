...
class ProductIncrementTest {
  ...
  void setUp() {
    ...
    productIncrement = ProductIncrement.builder().withName("Macallan Team PI 3").withIterations(
        Lists.newArrayList(
            Iteration.builder().withNumber(1).withRecommendedLoad(Estimate.builder().withDev(10).withCt(10).withFt(10).build()).withCapacity(Estimate.builder().withDev(10).withCt(10).withFt(10).build()).build(),
            Iteration.builder().withNumber(2).withRecommendedLoad(Estimate.builder().withDev(10).withCt(10).withFt(10).build()).withCapacity(Estimate.builder().withDev(10).withCt(10).withFt(10).build()).build(),
            Iteration.builder().withNumber(3).withRecommendedLoad(Estimate.builder().withDev(10).withCt(10).withFt(10).build()).withCapacity(Estimate.builder().withDev(10).withCt(10).withFt(10).build()).build()
        )
    ).build();
  }

  @Test
  void planBacklogInIterations() {
